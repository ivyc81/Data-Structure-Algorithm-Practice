...
describe("balancedBrakets", function () {
  it("should return true for balanced string", function() {
    expect(balancedBrakets('hello')).toEqual(true);
    expect(balancedBrakets('(hi) [there]')).toEqual(true);
    expect(balancedBrakets('(hi [there])')).toEqual(true);
    expect(balancedBrakets('(((hi)))')).toEqual(true);
  });

  it("should return false for unbalanced string", function() {
    expect(balancedBrakets('(hello (bracket left open at end)')).toEqual(false);
    expect(balancedBrakets('(nope] (wrong type closed)')).toEqual(false);
    expect(balancedBrakets('((ok) [nope)] (closed out of order)')).toEqual(false);
  });
});